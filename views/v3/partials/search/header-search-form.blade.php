...
'method' => 'get',
'action' => $homeUrl,
'classList' => $applyFilters('headerSearchFormClassList', ['search-form', 'u-print-display--none', 'u-display--flex@lg',
'u-display--flex@xl', 'u-display--none@xs', 'u-display--none@sm', 'u-display--none@md']),
